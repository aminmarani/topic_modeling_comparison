...
wiki_docs = loading_wiki_docs('./data/wiki_sampled_1p.txt')
#doing pre-processing on wiki-pedia documents
pre_processed_wiki,no_var = preprocess_data(wiki_docs,extra_stopwords=extra_stopwords)
...
n_topics = 6
ldaMallet = LdaMallet(mallet_path, corpus=doc_term_matrix, num_topics=n_topics, id2word=vocab_dict,random_seed = 54321,optimize_interval=50)
